...
const Home = () => {
  ...
  const getIcon = (item: any) => {
    ...
    if (t.includes("lengkap") || t.includes("integrasi") || t.includes("satu p")) return <Box size={24} className="text-black" />;
    if (t.includes("administrasi") || t.includes("rapi") || t.includes("dokumen")) return <FileText size={24} className="text-black" />;
    if (t.includes("skala") || t.includes("jangkauan") || t.includes("luas")) return <TrendingUp size={24} className="text-black" />;
    if (t.includes("teknologi") || t.includes("digital") || t.includes("sistem")) return <Laptop size={24} className="text-black" />;
    if (t.includes("cepat") || t.includes("responsif")) return <Zap size={24} className="text-black" />;
    if (t.includes("aman") || t.includes("terpercaya")) return <ShieldCheck size={24} className="text-black" />;
    if (t.includes("inovasi") || t.includes("kreatif") || t.includes("solusi")) return <Lightbulb size={24} className="text-black" />;
    if (t.includes("fokus") || t.includes("klien") || t.includes("pendidik")) return <Users size={24} className="text-black" />;
